...
class SupplierController extends Controller{
    ...
    public function index(Request $request) {
        $data = Supplier::get();
        return view('superadmin.supplier.index', compact('data'));
    }

    public function create(Request $request) {
        return view('superadmin.supplier.add');
    }
    ...
    public function store(Request $request) {
        ...
        if($supplier->save()){
            return redirect()->route('superadmin.supplier')->with('success', 'Supplier added successfully!');
        }else{
    ...
    public function edit(Request $request, $id) {
        ...
        return view('superadmin.supplier.edit', compact('data'));
    }
