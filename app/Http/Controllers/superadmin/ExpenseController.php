...
class ExpenseController extends Controller{
    ...
    public function index(Request $request) {
        $data = Expense::get();
        return view('superadmin.expense.index', compact('data'));
    }

    public function create(Request $request) {
        return view('superadmin.expense.add');
    }
    ...
    public function store(Request $request) {
        ...
        if($expense->save()){
            return redirect()->route('superadmin.expense')->with('success', 'Expense added successfully!');
        }else{
    ...
    public function edit(Request $request, $id) {
        ...
        return view('superadmin.expense.edit', compact('data'));
    }
