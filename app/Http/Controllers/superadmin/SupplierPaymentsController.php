...
class SupplierPaymentsController extends Controller{
    ...
    public function index(Request $request) {
        ...
        return view('superadmin.supplier-payments.index', compact('data'));
    }

    public function create(Request $request) {
        $suppliers = Supplier::get();
        return view('superadmin.supplier-payments.add', compact('suppliers'));
    }
    ...
    public function store(Request $request) {
        ...
        if($supplier->save()){
            return redirect()->route('superadmin.supplier-payment')->with('success', 'Supplier payment added successfully!');
        }else{
    ...
    public function edit(Request $request, $id) {
        ...
        $suppliers = Supplier::get();
        return view('superadmin.supplier-payments.edit', compact('data', 'suppliers'));
    }
