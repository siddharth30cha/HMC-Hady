...
class ProductController extends Controller{
    ...
    public function create(Request $request) {
        ...
        return view('superadmin.product.add', compact('categories'));
    }
    ...
    public function store(Request $request) {
        ...
        if($product->save()){
            return redirect()->route('superadmin.product')->with('success', 'Product added successfully!');
        }else{
    ...
    public function edit(Request $request, $id) {
        ...
        $categories = Category::get();
        return view('superadmin.product.edit', compact('data', 'categories'));
    }
    ...
    public function addMultiple(Request $request) {
        return view('superadmin.product.addMultiple');
    }
    ...
    public function storeMultiple(Request $request){
        ...
        fclose($fileHandle);
        return redirect()->route('superadmin.product')->with('success', 'Product imported successfully!');
    }
