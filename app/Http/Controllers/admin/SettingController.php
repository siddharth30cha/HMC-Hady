...
class SettingController extends Controller{
    ...
    public function index(Request $request) {
        ...
        return view('admin.settings.add', compact('store', 'pos', 'currency'));
    }
    ...
    public function storeInformation(Request $request) {
        ...
        if(!empty($data['storeID'])){
            ...
            if($store->update()){
                return redirect()->route('admin.settings')->with('success', 'Store information updated successfully!');
            }else{
            ...
            $store->store_language = $data['store_language'];
            if($store->save()){
                return redirect()->route('admin.settings')->with('success', 'Store information added successfully!');
            }else{
                return redirect()->back()->with('error', 'Something went wrong!');
            }
        }
    ...
    public function posInformation(Request $request) {
        ...
        if(!empty($data['posID'])){
            ...
            if($pos->update()){
                return redirect()->route('admin.settings')->with('success', 'POS information updated successfully!');
            }else{
                return redirect()->back()->with('error', 'Something went wrong!');
            }
        }else{
            ...
            $pos->item_audio = $data['item_audio'];
            if($pos->save()){
                return redirect()->route('admin.settings')->with('success', 'POS information added successfully!');
            }else{
                return redirect()->back()->with('error', 'Something went wrong!');
            }
        }
    ...
    public function currencyInformation(Request $request) {
        ...
        if(!empty($data['currencyID'])){
            ...
            if($currency->update()){
                return redirect()->route('admin.settings')->with('success', 'Currency information updated successfully!');
            }else{
                return redirect()->back()->with('error', 'Something went wrong!');
            }
        }else{
            ...
            $currency->currency_trailing_zeros = $data['currency_trailing_zeros'];
            if($currency->save()){
                return redirect()->route('admin.settings')->with('success', 'Currency information added successfully!');
            }else{
                return redirect()->back()->with('error', 'Something went wrong!');
            }
        }
