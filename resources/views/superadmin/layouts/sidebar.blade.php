    ...
    <div class="main-sidebar" id="sidebar-scroll">
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                ...
                <li class="slide">
                    <a href="{{ route('superadmin.category') }}" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="hero-icon-sm me-3 text-gray-400">
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
                ...
                <li class="slide">
                    <a href="{{ route('superadmin.product') }}" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="hero-icon-sm me-3 text-gray-400">
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
                ...
                <li class="slide">
                    <a href="{{ route('superadmin.supplier') }}" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="hero-icon-sm me-3 text-gray-400">
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
                ...
                <li class="slide">
                    <a href="{{ route('superadmin.supplier-payment') }}" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="hero-icon-sm me-3 text-gray-400">
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
                ...
                <li class="slide">
                    <a href="{{ route('superadmin.expense') }}" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="hero-icon-sm me-3 text-gray-400">
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
                ...
                <li class="slide">
                    <a href="{{ route('superadmin.user') }}" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="hero-icon-sm me-3 text-gray-400">
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
                ...
                <li class="slide">
                    <a href="{{ route('superadmin.settings') }}" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="hero-icon-sm me-3 text-gray-400">
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
