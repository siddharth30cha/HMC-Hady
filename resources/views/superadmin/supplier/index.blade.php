            ...
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <div class="prism-toggle">
                        <a href="{{ route('superadmin.supplier.add') }}" class="btn btn-sm btn-primary-light">Add Supplier
                                ...
                                @if(!empty($data))
                                    ...
                                    @foreach($data as $val)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('superadmin.supplier.edit', $val->id) }}" class="btn btn-icon btn-primary btn-wave waves-effect waves-light">
                                                    <i class="ri-edit-box-line"></i>
                                                </a>
                                                <a class="btn btn-icon btn-danger btn-wave waves-effect waves-light removeData" href="javascript:void(0)" data-url="{{ route('superadmin.supplier.delete') }}" data-id="{{$val->id}}">
