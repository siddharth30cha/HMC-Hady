                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active text-muted" id="identification" role="tabpanel">
                                    <form method="post" action="{{ route('superadmin.storeInformation') }}" enctype="multipart/form-data" id="storeInfoForm">
                                        @csrf
                                ...
                                <div class="tab-pane text-muted" id="posInfo" role="tabpanel">
                                    <form method="post" action="{{ route('superadmin.posInformation') }}" enctype="multipart/form-data" id="posInfoForm">
                                        @csrf
                                ...
                                <div class="tab-pane text-muted" id="currency" role="tabpanel">
                                    <form method="post" action="{{ route('superadmin.currencyInformation') }}" enctype="multipart/form-data" id="posInfoForm">
                                        @csrf
