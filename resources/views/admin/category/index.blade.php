            ...
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <div class="prism-toggle">
                        <a href="{{ route('admin.category.add') }}" class="btn btn-sm btn-primary-light">Add Category
                                ...
                                @if(!empty($category))
                                    @foreach($category as $val)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.category.edit', $val->id) }}" class="btn btn-icon btn-primary btn-wave waves-effect waves-light">
                                                    <i class="ri-edit-box-line"></i>
                                                </a>
                                                <a class="btn btn-icon btn-danger btn-wave waves-effect waves-light removeData" href="javascript:void(0)" data-url="{{ route('admin.category.delete') }}" data-id="{{$val->id}}">
